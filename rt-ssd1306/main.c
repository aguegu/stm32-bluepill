...
void init(I2CDriver *i2cp) {
  ...
  uint8_t s[27] = {0x00, 0xae, 0xd5, 0x80, 0xa8, HEIGHT - 1, 0x40, 0x8d, 0x14, 0x20, 0x00, 0xa0, 0xc0, 0xda, 0x02, 0x81, 0x8f, 0xd9, 0xf1, 0xdb, 0x40, 0xa4, 0xa6, 0x2e, 0xaf, 0x00, 0x10};
